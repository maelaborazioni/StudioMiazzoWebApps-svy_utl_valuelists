 ...
 * @type {String}
 *
 * @properties={typeid:35,uuid:"D318B8D3-D24E-466D-B746-06CB031943E5",variableType:12}
 */
var svy_val_version = '6.0.1.86';

/**
 * @type {String}
 *
 * @properties={typeid:35,uuid:"d80bbd76-ed04-4a38-97e6-b60c404cbeea",variableType:12}
 */
 ...
 * @type {String}
 *
 * @properties={typeid:35,uuid:"0236d61e-ed1b-48c1-a867-13f862532188",variableType:12}
 */
var vlt_owner_id = '1';
...
function svy_val_startup_setvaluelists()
{
	...
	for ( var i = 1 ; i <= _dataSetValueLists.getMaxRowIndex() ; i++ )
	{
		if( _dataSetValueLists.getValue(i,4) != 1 /*not a VL based on a custom query*/)
		{
			...
			_args[1] = globals.owner_id
			_args[2] = _dataSetValueLists.getValue(i,1);
			_args[3] = globals.owner_id
